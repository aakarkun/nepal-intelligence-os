...
export const env = {
  ...
  CRON_ECN_MINUTES: Number(process.env.CRON_ECN_MINUTES) || 30,
  ...
  SCRAPLING_REQUEST_DELAY_MS:
    Number(process.env.SCRAPLING_REQUEST_DELAY_MS) || 1000,
  MARKET_ASSET_MINUTES: Number(process.env.MARKET_ASSET_MINUTES) || 360,
